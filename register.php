...
<div><br/><center><h2><font face="verdana" size="+1" color="silver">Register Yourself</font></h2></center></div>
<div>
...
<fieldset style="background:#silver;width:50%">
<br><br>
<form method="post" name="f1" onSubmit="return vali()">
<table width="366" border="0" align="center">

  <tr>
    <td><div align="center"><strong><font size="+1" face="verdana">Title:</font></strong></div></td>
    <td><label>
  ...
  <tr>
    <td width="164"><div align="center"><font size="+1" face="verdana"><b> First&nbsp;Name:</b></font></div></td>
    <td width="192">
      
        <input name="t1" type="text" id="t1" onChange="return fnam()">    </td>
  </tr>
  <tr>
    <td><div align="center"><font size="+1" face="verdana"><strong>Last name:</strong></font></div></td>
    <td><input name="t2" type="text" id="t2" onChange="return lnam()" ></td>
  </tr>
  <tr>
    <td><div align="center"><font size="+1" face="verdana"><b>&nbsp;Gender:</b> </font></div></td>
  ...
  <tr>
    <td><div align="center"><font size="+1" face="verdana"><b>&nbsp;Enter Email : </b></font></div></td>
    <td><input name="t3" type="text" id="t3" onChange="return email()"></td>
  </tr>
  <tr>
    <td><div align="center"><font size="+1" face="verdana"><b>&nbsp;Choose a  Password:</b> </font></div></td>
    <td><input name="p1" type="text" id="p1" onChange="return pass()"></td>
  </tr>
  <tr> <td><div align="center"><font size="+1" face="verdana"><b>Phone no: </b></font></div></td>
    <td><input name="t5" type="text" id="t5" onChange="return phone()"></td>
  </tr>
  <tr>
    <td><div align="center"><font size="+1" face="verdana"><strong>Address:</strong></font></div></td>
    <td><label>
      <textarea name="t6" id="t6" value="return add()"></textarea>
    </label></td>
  </tr>
  <tr>
    <td><div align="center"><font size="+1" face="verdana"><strong>City:</strong></font></div></td>
    <td><input name="t7" type="text" id="t7" onChange="return city()"></td>
  </tr>
  <tr>
    <td><div align="center"><font size="+1" face="verdana"><strong>Country:</strong></font></div></td>
    <td><input name="t8" type="text" id="t8" onChange="return coun()"></td>
  </tr>
  <tr>
    <td><div align="center"><strong><font size="+1" face="verdana">Date of Birth: </font></strong></div></td>
    <td><label>
      <input name="t9" type="Date" id="t9">
    </label></td>
  </tr>
  <tr>
