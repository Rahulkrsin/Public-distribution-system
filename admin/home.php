...
<div style="width:86.25%;height:27%;float:right;background-color:#855C33">
...
<div style="width:13.7%;float:left;background-color:#855C33">
  <div align="center"><br />
      <br />
...
echo $count;
	...
	<br>
	<br>
	<a href="?con=upd"><font color="#FFFFFF" size="+2">update</a>
	<br/>
	
	<br>
	<a href="?con=del"><font color="#FFFFFF" size="+2">delete item</a>
	<br/><br/>
