...
$itemno=$_REQUEST['itemno'];
   ...
   echo "<tr>
   <tr><td><img src='admin/itempics/$i.jpg' height='300' width='300'></td>
   <td><b><font face='Comic sans MS' size='+1'>Item No:</b>".$arr['itemno'].
   "<br><b>Price:</b>Rs&nbsp;".$arr['price'].
   "<br><b>Product:<br></b>".$arr['info'].
   " </font><br><br><a href='index.php?con=12 & itemno=$i'><img src='images/3.gif' width='70' height='20'/></a>  </td>
