...
if($_REQUEST['sub'])
  {
    ...
    if(mysql_query("update items set catg='$catg',subcatg='$subcatg',img='$img',itemno='$itemno',price='$price',info='$desc' where itemno='$n' "))
	   {
...
<td><select name=subcat onChange="AjaxFunction(this.value);">
 <?php
require "config.php";// connection to database 
$m=mysql_query("select * from subcategory ");
